...
public class Usuario {
    ...
    public Reserva reservarCabina(Cabina cabina, Date fechaExpiracion) {
        ...
        Auditoria.registrar(String.format("Usuario %s genero la reserva %s", getNombre(), reserva.getId()));
        return reserva;
    }
    ...
    public Incidente reportarIncidente(String descripcion, TipoIncidente tipo, ManejadorIncidente manejador) {
        ...
        Auditoria.registrar(String.format("Usuario %s reporto un incidente: %s", getNombre(), descripcion));
